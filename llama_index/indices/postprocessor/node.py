...
DEFAULT_INFER_PREV_NEXT_TMP = (
"Предоставляется текущая контекстная информация. \n"
    "Также предусмотрен вопрос. \n"
    "Вы являетесь поисковым агентом, решающим, следует ли проводить поиск в "
    "хранилище документов для получения дополнительного предыдущего контекста или будущего контекста. \n"
    "Учитывая контекст и вопрос, верните ПРЕДЫДУЩИЙ, или СЛЕДУЮЩИЙ, или НЕТ. \n"
    "Примеры: \n\n"
    "Контекст: Описывает опыт автора в Y Комбинатор."
    "Вопрос: Чем занимался автор после своего пребывания в Y Комбинатор? \n"
    "Ответ: СЛЕДУЮЩИЙ \n\n"
    "Контекст: Описывает опыт автора в Y Комбинатор."
    "Вопрос: Чем занимался автор до своего прихода в Y Комбинатор? \n"
    "Ответ: ПРЕДЫДУЩИЙ \n\n"
    "Контекст: Опишите опыт автора в Y Комбинатор."
    "Вопрос: Что автор делал в Y Комбинатор? \n"
    "Ответ: НЕТ \n\n"
...
DEFAULT_REFINE_INFER_PREV_NEXT_TMP = (
"Предоставляется текущая контекстная информация. \n"
    "Также предусмотрен вопрос. \n"
    "Также приведен существующий ответ.\n"
    "Вы являетесь поисковым агентом, решающим, следует ли проводить поиск в "
    "хранилище документов для получения дополнительного предыдущего контекста или будущего контекста. \n"
    "Учитывая контекст, вопрос и предыдущий ответ",
    "вернуть ПРЕДЫДУЩЕЕ, или СЛЕДУЮЩЕЕ, или НИЧЕГО.\n"
    "Примеры: \n\n"
    "Контекст: {context_msg}\n"
    "Вопрос: {query_str}\n"
