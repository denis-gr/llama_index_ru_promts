...
DEFAULT_SYNONYM_EXPAND_TEMPLATE = """
Генерируйте синонимы или возможную форму ключевых слов в общей сложности до {max_keywords},
учитывая возможные случаи использования заглавных букв, множественного числа, распространенных выражений и т.д.
Укажите все синонимы ключевых слов в формате, разделенном запятыми: 'СИНОНИМЫ: <ключевые слова>'
Обратите внимание, результат должен быть в одной строке только с одним префиксом "СИНОНИМЫ: "
----
КЛЮЧЕВЫЕ СЛОВА: {question}
----
"""
